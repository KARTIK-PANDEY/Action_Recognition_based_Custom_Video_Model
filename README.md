...
Where `best_mAP@0.5IOU_epoch_47.pth` is the trained model checkpoint, and `441.mp4` is the input video.
...
1. The dataset is very small, leading to limited training.
2. Almost 90% of the labels are "stand", causing class imbalance.
